...
public class Test {
    public static void main(String[] args) {
        //1.子类不能继承的内容
        //Zi z = new Fu();//子类变量 不能指向父类的对象    父类的构造方法，不能继承给子类(构造方法格式:权限修饰符 当前类名(){})
        Zi z = new Zi();
        //System.out.println("花了"+z.money);//子类不能直接使用父类的私有内容
        System.out.println("花了"+z.getMoney());
        System.out.println("--------");
        //2.子父类中出现同名变量
        Zi z2 = new Zi();
        //访问子父类中，不同名变量
        System.out.println(z2.fuNum);
        System.out.println(z2.ziNum);
        //访问子父类中，同名变量   优先使用的是子类自己的该变量(就近原则)
        ...
        z3.fuMethod();
        z3.ziMethod();
        //访问子父类中，同名成员方法   优先使用的是子类自己的该变量(就近原则)
        z3.method();
        System.out.println("--------");
        //4.方法重写
        //子类中定了以与父类一模一样的方法，就叫做方法重写。
        //意义:替换掉父类的功能，对该功能做增强实现。
        Zi z4 = new Zi();
        z4.show();
        System.out.println("--------");
        //5.构造方法
        //子类构造方法，会默认访问父类的无参构造方法
        //意义:保证在初始化子类内容前，先初始化父类的内容。
