...
public class Test_01Object {
    public static void main(String[] args) {
        ...
        //重写toString
        Animal a = new Animal();
        System.out.println(a.toString());//null,0
        System.out.println(a);//打印对象，其实打印的就是对象的toString方法返回的结果。
        System.out.println("--------");

        //重写equals
        Animal a2 = new Animal("小花", 3);
        Animal a3 = new Animal("小花", 3);
        //需求:希望，如果两个对象的姓名和年龄相同，我就认为他们两个是同一个。
        System.out.println(a2.equals(a3));
        //避免空指针异常
        Animal a4 = new Animal(null,3);
